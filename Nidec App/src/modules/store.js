...
//     var id;
//     if (req.body.status == "ON") {
//         id = setInterval(stocare, 1000);
//         DbStatus.update({_id: "5b169de3b37adb19c42519da"}, id, function (err, numberAffected, rawResponse) {
//             console.log('stored id ')
//             });
//     };
//
//     if (req.body.status == "OFF") {
//         id = DbStatus.findOne({_id: "5b169de3b37adb19c42519da"}, Timeout);
//         clearInterval(id);
//         console.log(id);
//     };
// };
